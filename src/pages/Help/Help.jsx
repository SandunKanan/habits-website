...
const workflowSteps = [
  ...
  },
  {
    title: "Review Today",
    description:
      "The Today page shows only habits that are currently due. Each card shows a tracking score, where 1.00 means the habit is due and on track, based on recent completions rather than old debt."
  },
  {
